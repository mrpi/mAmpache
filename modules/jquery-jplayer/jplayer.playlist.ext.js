...
jPlayerPlaylist.prototype._createListItem = function(media) {
        ...
        var listItem = "<li" + attrClass + " name=\"" + $(this.cssSelector.playlist + " ul li").length + "\" data-song_id=\"" + media['song_id'] + "\" data-album_id=\"" + media['album_id'] + "\" data-artist_id=\"" + media['artist_id'] + "\"><div>";
